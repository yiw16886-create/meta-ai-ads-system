...
export class SyncController {
  static async syncAdData(req: Request, res: Response, next: NextFunction): Promise<void> {
  ...
  static async syncStoreData(req: Request, res: Response, next: NextFunction): Promise<void> {
  ...
  static async syncCreatives(req: Request, res: Response, next: NextFunction): Promise<void> {
    const { startDate, endDate } = req.body;
    if (!startDate || !endDate) {
      res.status(400).json({ error: "startDate and endDate are required" });
      return;
  ...
  static async cronSyncMonthly(req: Request, res: Response, next: NextFunction): Promise<void> {
