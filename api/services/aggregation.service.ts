...
export async function aggregateData(startDate: string, endDate: string) {
  try {
    console.log(`[Aggregation Service] Starting aggregation for date range ${startDate} to ${endDate}`);
